...
e11 = Employee(Booth, 'trans', 'URM', 96, 1)
...
e24 = Employee(Flynn, 'trans', 'URM', 49, 1)
...
e95 = Employee(Escobar, 'female', 'URM', 4, 0)
e96 = Employee(Mcknight, 'female', 'URM', 35, 0)
e97 = Employee(Goodwin, 'female', 'URM', 66, 0)
e98 = Employee(Dickson, 'female', 'URM', 28, 0)
e99 = Employee(Colon, 'female', 'URM', 30, 0)
e100 = Employee(Monroe, 'female', 'URM', 5, 0)
e101 = Employee(Meyer, 'female', 'URM', 13, 0)
...
e153 = Employee(Mckee, 'female', 'WRM', 95, 0)
...
e158 = Employee(Baldwin, 'female', 'WRM', 44, 0)
e159 = Employee(Bentley, 'female', 'WRM', 94, 0)
e160 = Employee(Harrison, 'female', 'WRM', 71, 0)
e161 = Employee(Mcclure, 'female', 'WRM', 74, 0)
...
e173 = Employee(Gordon, 'female', 'WRM', 99, 0)
...
e179 = Employee(Taylor, 'male', 'WRM', 85, 0)
...
e195 = Employee(Reynolds, 'male', 'WRM', 95, 0)
...
e206 = Employee(Boyd, 'male', 'WRM', 99, 0)
...
e452 = Employee(Watson, 'male', 'ORM', 8, 0)
e453 = Employee(Haney, 'male', 'ORM', 63, 0)
e454 = Employee(Coleman, 'male', 'ORM', 41, 0)
e455 = Employee(Saunders, 'male', 'ORM', 20, 0)
e456 = Employee(Simon, 'male', 'ORM', 19, 0)
e457 = Employee(Oneal, 'male', 'ORM', 14, 0)
e458 = Employee(Zamora, 'male', 'ORM', 55, 0)
